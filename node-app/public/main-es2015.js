...
/* harmony import */ var _components_thank_you_thank_you_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/thank-you/thank-you.component */ "./src/app/components/thank-you/thank-you.component.ts");
/* harmony import */ var _components_mqtt_mqtt_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/mqtt/mqtt.component */ "./src/app/components/mqtt/mqtt.component.ts");
/* harmony import */ var _services_socket_socket_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./services/socket/socket.service */ "./src/app/services/socket/socket.service.ts");
/* harmony import */ var _services_chat_service_chat_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./services/chat-service/chat.service */ "./src/app/services/chat-service/chat.service.ts");
/* harmony import */ var _services_auth_service_auth_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./services/auth-service/auth.service */ "./src/app/services/auth-service/auth.service.ts");
/* harmony import */ var _services_loader_service_loader_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./services/loader-service/loader.service */ "./src/app/services/loader-service/loader.service.ts");
/* harmony import */ var _services_loader_service_loaderInterceptor_interceptor__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./services/loader-service/loaderInterceptor.interceptor */ "./src/app/services/loader-service/loaderInterceptor.interceptor.ts");
...
/* harmony import */ var _guards_logged_in_guard__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./guards/logged-in.guard */ "./src/app/guards/logged-in.guard.ts");
...
// Guards ----
const routes = [
    { path: 'login', component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_18__["LoginComponent"], canActivate: [_guards_logged_in_guard__WEBPACK_IMPORTED_MODULE_29__["LoggedInGuard"]] },
    { path: 'register', component: _components_register_register_component__WEBPACK_IMPORTED_MODULE_16__["RegisterComponent"], canActivate: [_guards_logged_in_guard__WEBPACK_IMPORTED_MODULE_29__["LoggedInGuard"]] },
    { path: 'thank_you', component: _components_thank_you_thank_you_component__WEBPACK_IMPORTED_MODULE_21__["ThankYouComponent"], canActivate: [_guards_logged_in_guard__WEBPACK_IMPORTED_MODULE_29__["LoggedInGuard"]] },
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_17__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_28__["AuthGuard"]] },
    { path: 'appliances', component: _components_mqtt_mqtt_component__WEBPACK_IMPORTED_MODULE_22__["MqttComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_28__["AuthGuard"]] },
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_thank_you_thank_you_component__WEBPACK_IMPORTED_MODULE_21__["ThankYouComponent"],
            _components_mqtt_mqtt_component__WEBPACK_IMPORTED_MODULE_22__["MqttComponent"]
        ],
        imports: [
        ...
        providers: [_services_socket_socket_service__WEBPACK_IMPORTED_MODULE_23__["SocketService"], _services_auth_service_auth_service__WEBPACK_IMPORTED_MODULE_25__["AuthService"], _services_loader_service_loader_service__WEBPACK_IMPORTED_MODULE_26__["LoaderService"], _services_chat_service_chat_service__WEBPACK_IMPORTED_MODULE_24__["ChatService"],
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HTTP_INTERCEPTORS"], useClass: _services_loader_service_loaderInterceptor_interceptor__WEBPACK_IMPORTED_MODULE_27__["LoaderInterceptor"], multi: true }],
...
LoaderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_loader_service_loader_service__WEBPACK_IMPORTED_MODULE_2__["LoaderService"]])
], LoaderComponent);
...
LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_auth_service_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
], LoginComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_services_chat_service_chat_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/chat-service/chat.service */ "./src/app/services/chat-service/chat.service.ts");
...
let MqttComponent = class MqttComponent {
    constructor(authService, chat) {
        this.authService = authService;
        this.chat = chat;
    ...
    sendMessage(applianceNumber) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.inter(applianceNumber).then((data) => {
                if (data)
                    this.refreshAppList();
            });
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('msglog', { static: true }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])
], MqttComponent.prototype, "msglog", void 0);
MqttComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-mqtt',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./mqtt.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/mqtt/mqtt.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./mqtt.component.scss */ "./src/app/components/mqtt/mqtt.component.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_auth_service_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"],
        src_app_services_chat_service_chat_service__WEBPACK_IMPORTED_MODULE_2__["ChatService"]])
], MqttComponent);
...
NavbarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_auth_service_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"],
...
let ProfileComponent = class ProfileComponent {
    constructor(authService, matDialog) {
        this.authService = authService;
    ...
    submitCurrentPassword() {
        ...
        this.authService.checkCurrentPassword(this.user.username, this.currentPass).subscribe(profile => {
            this.response = profile.msg;
            console.log(profile);
            if (profile.success) {
                this.currentPassDomBool = false;
                ...
                let swipe = document.getElementById('swipe-left');
                swipe.setAttribute('style', 'transform: translate(-150%)');
                let swipe2 = document.getElementById('swipe-right');
    ...
    submitNewPassword() {
        let x = document.getElementById('response');
        let y = document.getElementById('response2');
        this.authService.updatePassword(this.user.username, this.currentPass, this.newPass, this.newConfirmPass).subscribe(profile => {
            this.response = profile.msg;
            console.log(profile);
            if (profile.success) {
                this.newPassDomBool = false;
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('frmCurrentPass', { static: false }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
], ProfileComponent.prototype, "formValues", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('frmConfirmPass', { static: false }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
], ProfileComponent.prototype, "formValues2", void 0);
...
function validateUsername(c) {
    let usernameReg = /^(?=.{6,20}$)(?![_.])(?!.*[_.]{2})[a-zA-Z0-9._]+(?<![_.])$/;
...
AuthGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
], AuthGuard);
...
let AuthService = class AuthService {
    ...
    updatePassword(username, currentPassword, newPassword, newConfirmPassword) {
        ...
        return this.http.post('http://localhost:3000/users/update_password', newUser, { headers: headers })
    ...
    checkCurrentPassword(username, password) {
        ...
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/check_current_password', newUser, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
    getUserProfile() {
        const httpOptions = {
        ...
        return this.http.get('http://localhost:3000/users/profile', httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
    getAppInfo(param) {
        return this.http.get('http://localhost:3000/users/app-info', { params: param })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
    appOff(user) {
        console.log(user);
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/appliance-off', user, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
    appOn(user) {
        console.log(user);
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/appliance-on', user, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
...
ChatService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_socket_socket_service__WEBPACK_IMPORTED_MODULE_2__["SocketService"]])
], ChatService);
...
/* harmony import */ var _loader_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./loader.service */ "./src/app/services/loader-service/loader.service.ts");
...
module.exports = __webpack_require__(/*! C:\Users\Karan\Desktop\Test Security Github\IoT-Application-using-MEAN-Stack\angular-src\src\main.ts */"./src/main.ts");
